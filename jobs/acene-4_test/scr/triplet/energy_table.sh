...
#dmrg=($(grep -i 'Minimum energy encountered during all instructions' "$pre""_ag_dmrg_1000.out" | awk '{printf "%3.6f\n", $9}'))
#
##write in a table
#
#printf "\\hline\n" 
...
dmrg=($(grep -i 'Minimum energy encountered during all instructions' "$pre""_b3u_dmrg_1000.out" | awk '{printf "%3.6f\n", $9}'))
...
dmrg=($(grep -i 'Minimum energy encountered during all instructions' "$pre""_b2u_dmrg_1000.out" | awk '{printf "%3.6f\n", $9}'))
...
dmrg=($(grep -i 'Minimum energy encountered during all instructions' "$pre""_b1g_dmrg_1000.out" | awk '{printf "%3.6f\n", $9}'))
